...
/* harmony import */ var _testData__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../testData */ "./testData.js");
...
var MainWrapper = styled_components__WEBPACK_IMPORTED_MODULE_13__["default"].div.withConfig({
  displayName: "shop__MainWrapper",
  componentId: "sc-78y3xq-0"
})(["background:rgb(249,250,252);overflow-x:hidden;width:100%;display:flex;padding:1% 5% 1% 5%;.right{width:100%;display:flex;justify-content:space-evenly;flex-direction:row;flex-wrap:wrap;}.left{padding:2%;margin-top:1%;display:flex;height:100vh;width:300px;background:#fff;border-color:rgba(0,0,0,0.09);box-shadow:0 2px 8px rgba(0,0,0,0.09);}"]);
var BackgroundHeader = styled_components__WEBPACK_IMPORTED_MODULE_13__["default"].div.withConfig({
  displayName: "shop__BackgroundHeader",
  componentId: "sc-78y3xq-1"
})(["background:url(\"../static/images/shop-cover.jpeg\");width:100%;background-size:cover;background-repeat:no-repeat;background-position:100px 50px;height:250px;"]);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Shop, [{
    ...
    value: function render() {
      ...
      return __jsx(_components_clientComponents_Layout__WEBPACK_IMPORTED_MODULE_11__["default"], {
        ...
        __self: this
      }, _testData__WEBPACK_IMPORTED_MODULE_14__["default"].map(function (item) {
...
//# sourceMappingURL=shop.js.ec10f8f01d39900bede0.hot-update.js.map